...
class BlockItem(QGraphicsRectItem):
    def __init__(self, scene, block_type, title, x, y, width=180, height=100):
    ...
    def get_header_color(self, block_type):
        colors = {
            ...
            "compare": "#8A2BE2", 
            "greater_equal": "#8A2BE2", 
            "less_equal": "#8A2BE2",    # BlueViolet
    ...
    def add_connection_point(self, point_name, label,  left_side=False):
        ...
        if left_side:
            text.setPos(point.x() - text.boundingRect().width() - 5, point.y() - 8)
        else:
